...
public class Item {
    ...
    public static void loadItems() {
        ...
        new Item(new ItemStack(Material.GLOWSTONE), 7, 2, 0, 0);
        ...
        new Item(new ItemStack(Material.COBBLESTONE), 10, 5, 32, 16);
        new Item(new ItemStack(Material.TNT), 0, 0, 5, 1);
        new Item(new ItemStack(Material.SADDLE), 0, 0, 1, 1);
        new Item(new ItemStack(Material.COAL), 2, 0, 5, 0);
        ...
        new Item(new ItemStack(Material.VILLAGER_SPAWN_EGG), 0, 0, 3, 1);
        new Item(new ItemStack(Material.EXPERIENCE_BOTTLE), 5, 1, 16, 10);
        new Item(new ItemStack(Material.EMERALD), 3, 1, 10, 5);
        new Item(new ItemStack(Material.APPLE), 10, 3, 0, 0);
        new Item(new ItemStack(Material.BREAD), 10, 5, 0, 0);
        new Item(new ItemStack(Material.GOLDEN_APPLE), 0, 0, 2, 2);
        new Item(new ItemStack(Material.MELON_SLICE), 10, 10, 0, 0);
        new Item(new ItemStack(Material.WOODEN_SHOVEL), 1, 1, 0, 0);
        new Item(new ItemStack(Material.WOODEN_PICKAXE), 1, 1, 0, 0);
        new Item(new ItemStack(Material.STONE_SHOVEL), 1, 1, 1, 1);
        ...
        new Item(new ItemStack(Material.ARROW), 5, 5, 12, 12);
                /*
